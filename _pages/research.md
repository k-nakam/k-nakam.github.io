...
1. A formal framework for using GenAI in causal and statistical inference: Imai and Nakamura (2026a, 2026b)
2. Dynamic causal inference for unstructured data: Nakamura and Imai (2026+); Nakamura, Breuer, Crespin, Dietrich, and Imai (2026+)
3. Software (**gpi-pack**): Nakamura and Imai (2025, maintainer)
...
1. General strategies and recommendations for AI-assisted annotation: Nakamura, Tan, and Yean (2026+)
2. Efficient statistical inference with low-quality and noisy annotations: Nakamura (2025+)
3. Downstream analysis when only indirect validation is available: Nakamura and Egami (2026+)
...
1. Identification and estimation strategies for human–AI interactions: Nakamura (2026+)
2. Using AI interviewers to probe respondents' understanding of survey questions: Hinck, King, Nakamura, and Stewart (2026+)