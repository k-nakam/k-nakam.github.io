...
\section{Peer-Reviewed Publications}
  \CVSubHeadingListStart
  \CVSubheading
  {{Understanding the Impact of Military Service on Support for Insurrection in the United States}}{}
  {\textit{Journal of Conflict Resolution}, with Robert Pape, Keven Ruby, and Kyle Larson \textcolor{sanguria}{[\underline{\href{https://journals.sagepub.com/doi/10.1177/00220027241267216}{URL}}]}
  }{}
\CVItemListStart
...
\CVItemListEnd
    ...
    \CVSubheading
      ...
      \textcolor{sanguria}{[\underline{\href{https://ijoc.org/index.php/ijoc/article/view/18676}{URL}}]}
      }{}
    \CVItemListStart
...
\CVSubHeadingListStart
\CVSubheading
      {\small{Causal Representation Learning with Generative Artificial Intelligence: Application to Texts as Treatments}}{}
      {\textit{Working paper}, with Kosuke Imai, Presented at PolMeth2024
      \textcolor{sanguria}{[\underline{\href{https://arxiv.org/abs/2410.00903}{URL}}]}
      }{}
    \CVItemListStart
...
\item{\textbf{Kentaro Nakamura} (2024, Poster). "Causal Inference with Unstructured High-Dimensional Treatments using Deep Generative Models: Applications to Images and Texts", \textit{2024 Meeting of the Society for Political Methodology}}
...
\CVSubheading
      ...
      \CVItemListStart
        \CVItem{Worked on the project of the automated cognitive debriefing (co-author)}
      \CVItemListEnd
...
\begin{itemize}[leftmargin=0.5cm, label={}]
  ...
  %\item{\textbf{Southern Political Science Association Annual Meeting (2022)}, Discussant on the panel \textit{Comparative Media Coverage and Discourse}}
\end{itemize}
